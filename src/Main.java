...
public class Main{
    public static void main(String[] args) {
        ...
        int removedAge = hashTable.remove("Bob");
        System.out.println("Bob's age was " + removedAge);

        // Check if the hash table contains a value
        boolean containsAge30 = hashTable.contains(30);
        System.out.println("Hash table contains age 30: " + containsAge30);

        // Retrieve the key associated with a value
        String keyForAge35 = hashTable.getKey(35);
        System.out.println("Key for age 35: " + keyForAge35);
